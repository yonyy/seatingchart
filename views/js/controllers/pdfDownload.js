...
['$rootScope', '$scope', '$state', '$stateParams', '$filter', 'resource', '$uibModalInstance', 'growl', 'students', 'seats',
function($rootScope, $scope, $state, $stateParams, $filter, resource, $uibModal, growl, students, seats) {
    var self = this;
    self.formats = [
        {
        ...
        content: [
            {
                text: [
                    ...
                    {text: self.predicate.text, style: 'predicate'}
                ]
            },{
                columns: []
            }
